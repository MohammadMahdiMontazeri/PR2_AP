...
def addCart():
    ...
    new_cart_product = Cart(product_name=Products.product_name, price_toman=Products.price_toman, price_dollar=Products.price_dollar, count=Products.count, gdrive_link=Products.gdrive_link)
